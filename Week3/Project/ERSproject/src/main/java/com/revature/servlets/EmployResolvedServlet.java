...
/**
 * Servlet implementation class EmployResolvedServlet
 */
public class EmployResolvedServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Collection<Reimbursement> c = dao.selectEmployResolvedReimbursements(e_id);
