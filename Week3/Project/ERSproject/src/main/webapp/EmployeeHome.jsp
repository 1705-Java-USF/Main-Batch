...
<div class="well"  id="homeDIV"> 
	...
	<p id="homeP">
	<br> <br> <br> <br>
	The Reimbursements Hub allows you request reimbursements. Through our hub, you can request and track 
	reimbursements requests you've made. You can also update your own account information. </p>
</div>