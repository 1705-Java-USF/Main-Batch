...
public class CreateSession extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Grab existing session object or create a new one if it doesnt exit
		...
		if(session.isNew()){
			...
			out.println("CURRENTLY LOGGED IN AS: "+ ((String)session.getAttribute("fname")).toUpperCase()
					+ " " + ((String)session.getAttribute("lname")).toUpperCase());
		}
