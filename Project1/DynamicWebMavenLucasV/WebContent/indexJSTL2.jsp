	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="index2.jsp">WELCOME</a></li>
				<li class="active"><a href="indexJSTL2.jsp">OPTIONS</a></li>
			</ul>
			<c:if test="${user!=null}">
						...
						<c:set var = "role" scope = "session" value = "${role}"/>
	     				<c:if test="${role < 3}">
							<div class="pagination">
								<ul class="pagination">
									<li><a href="viewHunters.jsp">View Hunters</a></li>
									<li><a href="viewPending.jsp">View Quest Requests</a></li>
									<li><a href="#">View Proof of Completion</a></li>
									<li><a href="viewPending.jsp">View Completed Quests</a></li>
								</ul>
							</div>
						</c:if>
	     				<c:if test="${role > 2}">
							<div class="pagination">
								<ul class="pagination">
									...
									<li><a href="#">Upload Proof of Completion</a></li>
