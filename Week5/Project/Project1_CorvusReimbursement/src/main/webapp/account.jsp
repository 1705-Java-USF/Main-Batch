	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">
							...
							<ul class="dropdown-menu">
								<li class="active"><a href="account.jsp">Account Information</a></li>
			...
			<c:if test="${ sessionScope.role == 'Contributor' }">
				<c:redirect url="accountc.jsp"></c:redirect>
			</c:if>
		</div>
	</nav>
	<div class="container-fluid">
		<div class="jumbotron center-on-screen">
			...
			<form method="post" action="update-account.corvus">
				...
				<a class="btn btn-danger" href="manager.jsp">Return Home</a>
			</form>
		</div>
	</div>
</body>
