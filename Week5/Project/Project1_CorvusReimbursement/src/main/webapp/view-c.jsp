...
<head>
	...
	<script src="resources/js/view-c-table-ajax.js"></script>
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="view-c.jsp">VIEW ALL USERS</a>
			</ul>
			<c:choose>
		...
		<select id="contributorsSelect" class="form-control">
		</select>
	
		<table id="view-c-table" class="table table-striped">
	    </table>
	</div>
