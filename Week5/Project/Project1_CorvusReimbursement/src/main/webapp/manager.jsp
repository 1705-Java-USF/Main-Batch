...
<body>
	...
	<div class="container text-center">
		<div class="well"><h1><c:out value="${ sessionScope.role }"></c:out>&nbsp;<c:out value="${ sessionScope.firstname }"></c:out>&nbsp;<c:out value="${ sessionScope.lastname }"></c:out></h1></div>
			<button type="button" class="btn btn-block review">Review Contributor Reimbursements</button>
			<button type="button" class="btn btn-block view-users">View All Users</button>
			<button type="button" class="btn btn-block new-user">Add New Contributor</button>
	</div>
</body>
</html>