...
<head>
	...
	<script src="resources/js/table_c-ajax.js"></script>
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="my_reimbursements.jsp">VIEW MY REIMBURSEMENTS</a></li>
		...
		<table id="contributorTable" class="table table-striped">
		    <thead>
		    	<tr>
		    		<th>ID</th>
		        	<th>Amount</th>
